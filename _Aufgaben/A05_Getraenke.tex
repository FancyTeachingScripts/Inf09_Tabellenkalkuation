\Aufgabe{Getränkekalkulation}
{
    ...
    \LoesungLine{z.B. Besserer Überblick, Aufbau einer Intuition für den Kontext, geringere Gefahr, vor lauter Syntax den Überblick zu verlieren, \dq Divide-and-Conquer\dq, erst Planen, dann Umsetzen reduziert Fehler}{2}
...
\UnterAufgabe{Getränkekalkulation A1}{
    \LoesungTikz{
...
\UnterAufgabe{Getränkekalkulation A2}{
...
\UnterAufgabe{Getränkekalkulation A2 (2)}{
    \LoesungTikz{
...
\UnterAufgabe{Getränkekalkulation B1}{
...
\UnterAufgabe{Getränkekalkulation B2}{
    \hinweis{Der Kosten-Unterschied bezieht sich auf die \emphColB{Einkaufskosten} der beiden Händler (nicht auf den Gewinn).}
    ...
    \LoesungTikz{
            \node[dfddata, text width=2.4cm, minimum width=1pt] (e1) {Einkaufskosten bei Händler 1};
           % \node[dfddata, text width=0.5cm, minimum height=8pt, right=0.2cm of e1] (e2) {...};
            %\node[text width=0.5cm, minimum width=1pt, minimum height=8pt, right=0.2cm of e2] (edots) {...};
            %\node[dfddata, text width=0.5cm, minimum height=8pt, right=0.2cm of edots] (e3) {...};
            \node[dfddata, text width=2.4cm, right=0.2cm of e1] (eN) {Einkaufskosten bei Händler 2};
