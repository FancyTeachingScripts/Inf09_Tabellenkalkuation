    ...
    \begin{minipage}[t]{0.5\textwidth}
        ...
        \begin{enumerate}
            \item Öffne \UrlAndCode{drive.bycs.de} im Internetbrowser und melde dich mit deinen BYCS/Mebis-Logindaten an. \\
                \hinweis{Internetbrowser zeigen Websites an und sind unser üblicher Zugang zum Internet. Bekannte Browser sind \textbf{Mozilla Firefox}, Google Chrome oder Microsoft Edge.}
            \item Erstelle in deinem persönlichen Bereich einen neuen Ordner mit dem Namen \emph{Informatik\_09}.
